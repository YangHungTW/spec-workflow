...
Inline task review. Inputs: `git diff <slug>...<slug>-T<n>` for the task branch, PRD R-ids linked to the task from `05-plan.md`, and the performance rubric. Do NOT read the whole repo or the whole feature diff.
