...
This file is managed by rule-add tasks; don't hand-edit unless you mean it.
Add a row here whenever a new rule file is committed. Keep rows sorted by scope
then name.
...
| minimal-diff | common | should | [common/minimal-diff.md](common/minimal-diff.md) |
