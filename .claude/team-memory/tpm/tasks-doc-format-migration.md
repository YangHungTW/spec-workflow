...
description: When a downstream command (e.g. `/scaff:implement`) changes its required task-doc format mid-feature, do minimal edits — don't re-litigate scope.
type: pattern
created: 2026-04-16
updated: 2026-04-16
---
...
3. In STATUS Notes, write `TPM — added <field> and <section>
   (mid-stream tasks-doc update for new /scaff:<command>)`. Explicit
...
Feature `symlink-operation`, 2026-04-16: `/scaff:implement` went
