...
///
/// D3: the 16 scaff commands are grouped into three risk classes so that
...
///
/// The list is intentionally hardcoded — adding a new scaff command must
...
/// Risk classification for a scaff command.
