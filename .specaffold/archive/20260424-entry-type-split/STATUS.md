...
- 2026-04-24 archive — TPM retrospective complete: 6 memory entries written (1 update, 5 new): shared/dogfood-paradox-third-occurrence (10th occurrence), architect/commands-harvest-scope-forbids-non-command-md, tpm/tech-doc-addendum-pattern-for-mid-flight-decision-refinement, qa-tester/probe-anchor-spot-checks-should-span-spelling-variants, tpm/plan-time-file-existence-checks-must-re-run-at-sub-agent-dispatch, shared/auto-classify-argv-by-pattern-cascade. All approved by user.
